...
自己紹介スライド作成時に、LTのテーマに合わせて以下から適切な項目を選んで使用してください。

### キャッチコピー

「どんな素人でもAIとGASを使って1時間で業務改善します！！」
非エンジニアだからこそ、あなたの業務を自動化できるかも？
...
- X: https://x.com/keitaro_aigc
- note: https://note.com/keitaro_aigc
- Voicy
- GitHub

### 紹介文（詳細版）

AI×GASを使った"誰でも1時間でできる業務改善"を全国で推進。非エンジニアとして現場目線を大切にしながら、自治体・企業・個人の業務自動化を多数支援。タスク管理、スプレッドシート連携、通知・フォーム処理など、今日から使える即効型の仕組みを提案し、AI初心者でもその場で動く実践サポートを提供。

### 自己紹介スライドでの使い分け

- **AI系LT**: アンバサダー活動から関連するものを2〜3個 + キャッチコピー
- **GAS系LT**: 「非エンジニア」「業務自動化」を強調 + GAS関連の実績
- **Notion系LT**: Notion公式アンバサダー + Notionさいたま主宰
- **一般的なLT**: キャッチコピー + 主要アンバサダー2〜3個 + SNS
