...
// 出力
pres.writeFile({ fileName: "/home/user/sincerely-slide-skill-v2/output/test_all_patterns.pptx" })
  .then(function() {
    console.log("テスト完了: 全22パターンのスライドを生成しました");
    console.log("出力先: /home/user/sincerely-slide-skill-v2/output/test_all_patterns.pptx");
  })
  .catch(function(err) {
